...
class OnlineTrainerD:
    def __init__(self, robot, NN, alpha_r, theta_r):
        ...
        self.alpha = [1/5,1/5,1/(math.pi)]  # normalition avec limite du monde cartesien
    ...
    def theta_s(self, x,y, function = "Y_ATAN"):
    ...
    def train(self, target):
        ...
        while self.running:
            ...
            self.monitoring.append(monitoring_pose + monitoring_command + monitoring_drifting)
