...
#module en plus independant qui gere laffichage, fct de cout, trajectoire, gradient , vitesse des roues (sorties), distance(x,y,theta )(reel), affichage du reseau avec pytorch (avoir acces aux valeurs des parametres).
#verifier la sigmoid dans pytorch


#expliquer l'ancien code, recoder l'ancien code en utilisant pytorch.
#tester avec et sans adam la trajctoire et la condition initiale
#printer le  theta_s et la normalisation
#afficher les valeurs du reseau pour verifier si il y a vraiment une couche cachée/ comment pytorch a codé le reseau
