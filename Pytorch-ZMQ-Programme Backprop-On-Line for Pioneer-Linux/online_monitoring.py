...
class PyTorchOnlineTrainer:
    def __init__(self, robot, nn_model, visualizer=None):
        """
        Args:
            ...
            visualizer (RobotVisualizer, optional): instance du visualiseur
        """
        self.robot = robot
        ...
        # Variables pour stocker les informations d'apprentissage
    ...
    def train(self, target):
        ...
        # Si le visualiseur est configuré, définir la cible
        if self.visualizer:
            self.visualizer.set_target(target[0], target[1], target[2])
